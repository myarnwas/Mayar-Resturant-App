   ...
   { /*form */}
    ...
    <View style={styles.formContainer}>
       ...
       <SimpleLineIcons name={"lock"} color={colors.secondary} size={30}></SimpleLineIcons>
        ...
        <TouchableOpacity style={styles.LoginButtonWrapper}onPress={handleLoginHome1}>
        ...
        <View style={styles.buttonContainear}>
                  <TouchableOpacity
                    style={[styles.LoginbuttonWrapper, { backgroundColor: '#ffff00' }]}
                    onPress={handleLoginHome1}>
                    <Text style={styles.LoginbuttonText}>handleLoginHome1</Text>
                  </TouchableOpacity>
        </View>
    </View>
    </View>   
